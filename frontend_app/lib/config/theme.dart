...
class AppTheme {
  ...
  static ThemeData get lightTheme => ThemeData(
    ...
    colorScheme: const ColorScheme.light(
      primary: violet, // Use violet as primary for light mode for better contrast
      secondary: cyan,
      tertiary: neonRed,
      surface: lightSurface,
      surfaceContainerHighest: Color(0xFFE2E8F0), // For inputs/cards
    ...
    cardTheme: CardThemeData(
      color: lightSurface.withOpacity(0.9), // More opaque for visibility
      elevation: 2, // Slight elevation for separation
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(16),
        side: BorderSide(color: Colors.black.withOpacity(0.05)), // Subtle border
      ),
