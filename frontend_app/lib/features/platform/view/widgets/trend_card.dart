...
class TrendCard extends StatelessWidget {
    ...
    return Row(
      ...
      children: [
        _buildEngagementItem(
          ...
          _formatNumber(trend.likes),
          colorScheme,
          context,
        ),
        _buildEngagementItem(
          Icons.chat_bubble_outline,
          _formatNumber(trend.comments),
          colorScheme,
          context,
        ),
        _buildEngagementItem(
          Icons.share_outlined,
          _formatNumber(trend.shares),
          colorScheme,
          context,
        ),
      ],
  ...
  Widget _buildEngagementItem(IconData icon, String count, ColorScheme colorScheme, BuildContext context) {
    return Row(
      mainAxisSize: MainAxisSize.min,
      children: [
        Icon(
